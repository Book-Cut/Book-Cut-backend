...
class ValoraController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['message' => 'Valoración creada correctamente', 'valora' => $valora], 201);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($valora) {
            ...
            return response()->json(['message' => 'Valoración actualizada correctamente', 'valora' => $valora]);
        } else {
            return response()->json(['message' => 'Valoración no encontrada'], 404);
        }
    }
